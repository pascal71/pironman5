...
installer = SF_Installer(
    ...
    python_source={
        'pironman5': './',
        'pm_auto': 'git+https://github.com/pascal71/pm_auto.git',
...
if args.disable_dashboard:
    ...
    installer.before_install_commands.pop('Download influxdb key')
    installer.before_install_commands.pop('Setup influxdb install source')
